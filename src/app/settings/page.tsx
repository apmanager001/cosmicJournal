...
function SettingsContent() {
  ...
  return (
    <div className="container mx-auto md:px-4 md:py-8">
      <PageHeaderCard
        icon={<Cog strokeWidth={2.5} />}
        title="Settings"
        description="Manage your preferences and subscription settings all in one place."
        rightContent={
          <>
      ...
      <div className="grid lg:grid-cols-3 gap-2 md:gap-4">
        <div className="md:col-span-3 space-y-8 mb-16 md:mb-0">
          {/* Account Settings */}
          <div className="p-6 customContainer mb-0 md:mb-4">
