        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-medium text-amber-800 mb-1">
              {getResourceIcon()} {getResourceLabel().charAt(0).toUpperCase() + getResourceLabel().slice(1)} Limit Reached
            </h3>
            <p className="text-sm text-amber-700 mb-3">
              You've reached your limit of {limit} {getResourceLabel()} on the free plan. 
              Upgrade to Pro for unlimited {getResourceLabel()} and more features!
            </p>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h3 className="text-sm font-medium text-blue-800 mb-1">
            {getResourceIcon()} Approaching {getResourceLabel().charAt(0).toUpperCase() + getResourceLabel().slice(1)} Limit
          </h3>
          <p className="text-sm text-blue-700 mb-3">
            You've used {currentCount} of {limit} {getResourceLabel()} on the free plan. 
